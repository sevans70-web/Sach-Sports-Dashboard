...
def _inject_css():
    st.markdown("""
    <style>
    :root{--soc-panel:#10251f;--soc-panel2:#173a31;--soc-border:#2f7160;--soc-accent:#55e6b5;--soc-soft:#b8d1c9}
    .soc-hero{border:1px solid var(--soc-border);border-radius:18px;padding:1rem 1.05rem;background:linear-gradient(135deg,var(--soc-panel),var(--soc-panel2));margin-bottom:.9rem}
    .soc-kicker{color:var(--soc-accent);font-size:.76rem;font-weight:850;letter-spacing:.08em;text-transform:uppercase}
