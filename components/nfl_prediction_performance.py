...
def render_nfl_prediction_performance(history: dict | None = None) -> None:
    st.markdown(
        """
        <style>
        ...
        div[class*="st-key-nfl_performance_period"] [role="radiogroup"]{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;width:100%!important;gap:0!important}
